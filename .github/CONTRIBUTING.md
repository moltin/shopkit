...
4. Set up the development environment and install the required dependencies. For more information, see [Setup](https://github.com/moltin/shopkit/blob/master/README.md).
